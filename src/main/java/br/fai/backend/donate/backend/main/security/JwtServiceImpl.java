...
public class JwtServiceImpl implements JwtService {
    ...
    @Override
    public String generateToken(UserDetails userDetails, String fullName, UsuarioModel.UserRole role, String email, int id) {
    ...
    public String createToken(Map<String, Object> claims, String subject) {
        ...
        final Date expirationDate = new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 10); // 10 horas
